...
const routes = [
	...
	// 商品分类路由
	{
		path: '/commodity_classification/table',
		name: 'commodity_classification_table',
		component: () => import('../views/commodity_classification/table.vue'),
		meta: {
			index: 0,
			title: '商品分类列表'
		}
	...
	{
		path: '/commodity_classification/view',
		name: 'commodity_classification_view',
		component: () => import('../views/commodity_classification/view.vue'),
		meta: {
			index: 0,
			title: '商品分类详情'
		}
	...
	// 商品中心路由
	{
		path: '/commodity_center/table',
		name: 'commodity_center_table',
		component: () => import('../views/commodity_center/table.vue'),
		meta: {
			index: 0,
			title: '商品中心列表'
		}
	...
	{
		path: '/commodity_center/view',
		name: 'commodity_center_view',
		component: () => import('../views/commodity_center/view.vue'),
		meta: {
			index: 0,
			title: '商品中心详情'
		}
